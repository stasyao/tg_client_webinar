...
class ChatFull(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "about", "participants", "notify_settings", "exported_invite", "can_set_username", "has_scheduled", "chat_photo", "bot_info", "pinned_msg_id", "folder_id", "call"]
    ...
    def read(data: BytesIO, *args: Any) -> "ChatFull":
        ...
        return ChatFull(id=id, about=about, participants=participants, notify_settings=notify_settings, exported_invite=exported_invite, can_set_username=can_set_username, has_scheduled=has_scheduled, chat_photo=chat_photo, bot_info=bot_info, pinned_msg_id=pinned_msg_id, folder_id=folder_id, call=call)
